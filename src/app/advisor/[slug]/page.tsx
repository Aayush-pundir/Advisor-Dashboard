...
const BENEFITS = [
  {
    title: "Free spend-leakage audit",
    desc: "A no-cost review of where petty cash, advances and vendor payments are quietly leaking today.",
  },
  {
    title: "Zero-cost onboarding",
    desc: "OmniCard's team handles the full switch — demo, setup, KYC and card issuance — at no charge.",
  },
  {
        ...
        <div style={{ maxWidth: 760, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
          ...
          <Reveal delay={0.1}>
            <p style={{ fontSize: "clamp(15.5px,3.4vw,18px)", lineHeight: 1.6, color: "rgba(27,23,20,0.68)", maxWidth: 600, margin: "0 auto" }}>
              {partner.contactName} is a Certified OmniCard Implementation Advisor, helping businesses in{" "}
              {partner.city} eliminate spend leakage with India&apos;s Business Fintech OS.
            </p>
          </Reveal>
        </div>
      </section>
